...
# Set Flash-RL environment variables (like GSM8K script)

export VERL_LOGGING_LEVEL=DEBUG
export VLLM_LOGGING_LEVEL=DEBUG
export VLLM_CONFIGURE_LOGGING=1
export VLLM_USE_V1=1  # Required for Flash-RL FP8 quantization
export TORCH_NCCL_AVOID_RECORD_STREAMS=1

RAY_ADDRESS='http://127.0.0.1:8265' ray job submit --runtime-env=${RUNTIME_ENV} \
-- python3 -m verl.trainer.main_ppo \
    --config-path=/lustre/fs1/portfolios/coreai/users/alexq/verl_main_fp8/verl/recipe/dapo/config \
    --config-name='ppo_megatron_trainer.test.yaml' \
    ...
    actor_rollout_ref.rollout.quantization=False \
