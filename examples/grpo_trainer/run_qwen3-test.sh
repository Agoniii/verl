set -x
cp -rp ~/workspace/projects/rl/verl_fp8/sglang.v0.4.8/* /usr/local/lib/python3.10/dist-packages/sglang/
sh kill.sh
...
OUTPUT_DIR=/lustre/raplab/client/xueh/workspace/projects/rl/verl_fp8/examples/grpo_trainer/nsys_files
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    2>&1 | tee /lustre/raplab/client/xueh/workspace/projects/rl/verl_fp8/examples/grpo_trainer/logs/${rollout_backend}_fp8.log 2>&1 &
